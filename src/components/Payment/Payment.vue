            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-sm-6 custom-margin">
                  ...
                  <input id="birthDate" v-model="cardHolder.birthdate" v-validate="'required'" :class="{'input-custom': true, 'is-danger': errors.has('birthDate') }" name="birthDate" type="text" placeholder="DD/MM/YYYY">
